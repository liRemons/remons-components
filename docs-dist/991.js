(self['webpackChunkremons_components'] = self['webpackChunkremons_components'] || []).push([
  [991],
  {
    ...
    35713: function (e, t, n) {
      ...
      t['Z'] = function (e) {
        return a.createElement('div', r({ className: '__dumi-default-alert' }, e));
      };
    },
    68991: function (e, t, n) {
          ...
          var e = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
            ...
            a = {
                  ...
                  for (var s in t)
                    if (t.hasOwnProperty(s)) {
                      ...
                      var l = t[s],
                        u = a.util.type(l);
                      'Object' !== u || i[o(l)]
                        ? 'Array' !== u || i[o(l)] || ((i[o(l)] = !0), e(l, n, s, i))
              ...
              tokenize: function (e, t) {
                ...
                var r = new s();
                return l(r, r.head, e), o(e, r, t, r.head, 0), c(r);
              },
              hooks: {
                all: {},
                add: function (e, t) {
            ...
            for (var p in n)
              if (n.hasOwnProperty(p) && n[p]) {
                ...
                for (var f = 0; f < g.length; ++f) {
                  ...
                  for (
                    var v = m.pattern || m, S = s.next, w = c;
                    S !== t.tail;
                    w += S.value.length, S = S.next
                  ) {
                    ...
                    if (!(A instanceof r)) {
                      var _,
                        T = 1;
                      if (y) {
                        if (((_ = i(v, w, e, h)), !_ || _.index >= e.length)) break;
                        var R = _.index,
                          x = _.index + _[0].length,
                          O = w;
                        O += S.value.length;
                        while (R >= O) (S = S.next), (O += S.value.length);
                        if (((O -= S.value.length), (w = O), S.value instanceof r)) continue;
                        for (
                          var I = S;
                          I !== t.tail && (O < x || 'string' === typeof I.value);
                          I = I.next
                        )
                          T++, (O += I.value.length);
                        T--, (A = e.slice(w, O)), (_.index -= w);
                      } else if (((_ = i(v, 0, A, h)), !_)) continue;
                      R = _.index;
                      var N = _[0],
                        F = A.slice(0, R),
                        L = A.slice(R + N.length),
                        D = w + A.length;
                      d && D > d.reach && (d.reach = D);
                      var C = S.prev;
                      F && ((C = l(t, C, F)), (w += F.length)), u(t, C, T);
                      var B = new r(p, b ? a.tokenize(N, b) : N, E, N);
                      if (((S = l(t, C, B)), L && l(t, S, L), T > 1)) {
                        var P = { cause: p + ',' + f, reach: D };
                        o(e, t, n, S.prev, w, P), d && P.reach > d.reach && (d.reach = P.reach);
                      }
                    }
                  }
                }
          ...
          return (
            (r.stringify = function e(t, n) {
              ...
              var i = {
                ...
                o = t.alias;
              o &&
                (Array.isArray(o) ? Array.prototype.push.apply(i.classes, o) : i.classes.push(o)),
                a.hooks.run('wrap', i);
              var s = '';
      ...
      (l['default'] = l),
        ...
        (u.languages.markup['doctype'].inside['internal-subset'].inside = u.languages.markup),
        ...
        Object.defineProperty(u.languages.markup.tag, 'addInlined', {
          value: function (e, t) {
            ...
            a['language-' + t] = { pattern: /[\s\S]+/, inside: u.languages[t] };
            var r = {};
            (r[e] = {
              pattern: RegExp(
              ...
              u.languages.insertBefore('markup', 'cdata', r);
          },
        }),
        Object.defineProperty(u.languages.markup.tag, 'addAttribute', {
          value: function (e, t) {
            u.languages.markup.tag.inside['special-attr'].push({
              pattern: RegExp(
                /(^|["'\s])/.source +
                  '(?:' +
                  e +
        ...
        (u.languages.ssml = u.languages.xml),
        (u.languages.atom = u.languages.xml),
        (u.languages.rss = u.languages.xml),
        (function (e) {
          var t =
          ...
          macro: {
            ...
            inside: {
              string: [
                ...
                u.languages.c['string'],
              ],
              char: u.languages.c['char'],
              comment: u.languages.c['comment'],
              'macro-name': [
              ...
              'directive-hash': /^#/,
              punctuation: /##|\\(?=[\r\n])/,
              expression: { pattern: /\S[\s\S]*/, inside: u.languages.c },
            },
          },
        }),
        u.languages.insertBefore('c', 'function', {
          constant:
        ...
        u.languages.insertBefore('javascript', 'operator', {
          'literal-property': {
            pattern:
        ...
        u.languages.markup &&
          ...
          u.languages.markup.tag.addAttribute(
          ...
          (e.languages.markdown = e.languages.extend('markup', {})),
            ...
            e.hooks.add('wrap', function (t) {
              if ('code-block' === t.type) {
                ...
                var s = e.languages[n];
                if (s) t.content = e.highlight(u(t.content), s, n);
          ...
          function p(e, a) {
            for (var r = 1, i = n; i < t.length; i++) {
              ...
              if ('punctuation' === o.type && 'string' === typeof s)
                if (e.test(s)) r++;
                else if (a.test(s) && (r--, 0 === r)) return i;
            }
            return -1;
          }
          function g(e, t) {
                ...
                if ('string' === typeof n || 'string' === typeof n.content) {
                  ...
                  if (-1 !== i) {
                    ...
                    var s = r.substring(0, i),
                      l = u(c[a]),
                      d = r.substring(i + a.length),
                      p = [];
                    if ((s && p.push(s), p.push(l), d)) {
                      var m = [d];
                      f(m), p.push.apply(p, m);
                    }
                    'string' === typeof n
                  ...
                  var b = n.content;
                  Array.isArray(b) ? f(b) : f([b]);
                }
              }
            }
            return (o = 0), f(p), new e.Token(a, p, 'language-' + a, t);
          }
              ...
              for (var a = [], r = 0; r < n.length; r++) {
                ...
                if (
                  ('string' !== typeof i &&
                    ('tag' === i.type && i.content[0] && 'tag' === i.content[0].type
                      ? '</' === i.content[0].content[0].content
                        ? a.length > 0 &&
                          a[a.length - 1].tagName === o(i.content[0].content[1]) &&
                          a.pop()
                        : '/>' === i.content[i.content.length - 1].content ||
                          a.push({ tagName: o(i.content[0].content[1]), openedBraces: 0 })
                  ...
                  r < n.length - 1 &&
                    ...
                    ((l += o(n[r + 1])), n.splice(r + 1, 1)),
                    r > 0 &&
                      ('string' === typeof n[r - 1] || 'plain-text' === n[r - 1].type) &&
                      ((l = o(n[r - 1]) + l), n.splice(r - 1, 1), r--),
        ...
        u.languages.insertBefore('go', 'string', {
          char: { pattern: /'(?:\\.|[^'\\\r\n]){0,10}'/, greedy: !0 },
        }),
        ...
        (u.languages.objc = u.languages.objectivec),
        (u.languages.ocaml = {
          comment: { pattern: /\(\*[\s\S]*?\*\)/, greedy: !0 },
        ...
        (u.languages.python['string-interpolation'].inside['interpolation'].inside.rest =
          u.languages.python),
        ...
        u.languages.insertBefore('scss', 'important', { variable: /\$[-\w]+|#\{\$[-\w]+\}/ }),
      ...
      var b = /\r\n|\r|\n/,
          ...
          while (o > -1) {
            while ((i = a[o]++) < r[o]) {
              ...
              if (
                ('string' === typeof p
                  ? ((c = o > 0 ? c : ['plain']), (u = p))
                  : ((c = y(c, p.type)), p.alias && (c = y(c, p.alias)), (u = p.content)),
                'string' === typeof u)
              ) {
                var g = u.split(b),
                  f = g.length;
                ...
                for (var m = 1; m < f; m++)
                  h(s), l.push((s = [])), s.push({ types: c, content: g[m] });
        ...
        k = function (e, t) {
          ...
          return (r.root = n), (r.plain = m({}, n, { backgroundColor: null })), r;
        };
      function v(e, t) {
        var n = {};
        for (var a in e)
          ...
          function t() {
            ...
            e.apply(this, n),
              f(this, 'getThemeDict', function (e) {
                ...
                var n = e.theme ? k(e.theme, e.language) : void 0;
              ...
              f(this, 'getLineProps', function (e) {
                var n = e.key,
                  ...
                  o = i,
                  s = m({}, o, { className: 'token-line', style: void 0, key: void 0 }),
                  l = t.getThemeDict(t.props);
                return (
                  void 0 !== l && (s.style = l.plain),
                  void 0 !== r && (s.style = void 0 !== s.style ? m({}, s.style, r) : r),
                  void 0 !== n && (s.key = n),
                  a && (s.className += ' ' + a),
                  s
                );
              ...
              f(this, 'getTokenProps', function (e) {
                ...
                return (
                  void 0 !== r && (l.style = void 0 !== l.style ? m({}, l.style, r) : r),
                  void 0 !== n && (l.key = n),
                  a && (l.className += ' ' + a),
                  l
                );
      ...
      var N = { acss: 'css', axml: 'xml' },
        F = function (e) {
          ...
          return a.createElement(
            ...
            a.createElement(
              w,
              A({}, g, { code: t, language: N[n] || n, theme: void 0 }),
              function (e) {
                var n = e.className,
                  r = e.style,
                  o = e.tokens,
                ...
                return a.createElement(
                  ...
                  o.map(function (e, t) {
                    return a.createElement(
                      ...
                      s({ line: e, key: t }),
                      e.map(function (e, t) {
                        return a.createElement('span', l({ token: e, key: t }));
                      }),
                    );
                  }),
                );
      ...
      var j = function (e) {
          var t,
            ...
            l,
            u = (0, a.useRef)(),
            c = (0, a.useContext)(s.context),
            d = c.locale,
            p = (0, s.useLocaleProps)(d, e),
            g = (0, s.useDemoUrl)(p.identifier),
            f = p.demoUrl || g,
            m =
              (null === o.m || void 0 === o.m ? void 0 : o.m.location.hash) ===
              '#'.concat(p.identifier),
            b = 1 === Object.keys(p.sources).length,
            h = (0, s.useCodeSandbox)(
            ...
            E = (0, s.useMotions)(p.motions || [], u.current),
            k = D(E, 2),
            v = k[0],
            S = k[1],
            w = (0, s.useCopy)(),
            ...
            O = x[0],
            I = x[1],
            N = (0, a.useState)(M(O, p.sources[O])),
            C = D(N, 2),
            B = C[0],
            P = C[1],
            $ = (0, a.useState)(Boolean(p.defaultShowCode)),
            G = D($, 2),
            j = G[0],
            U = G[1],
            z = (0, a.useState)(Math.random()),
            H = D(z, 2),
            q = H[0],
            Y = H[1],
            W = p.sources[O][B] || p.sources[O].content,
            Z = (0, s.useTSPlaygroundUrl)(d, W),
            K = (0, a.useRef)(),
            X = (0, s.usePrefersColor)(),
            V = D(X, 1),
            J = V[0],
            Q = p.actionBarRender,
            ee =
            ...
            a.createElement(
              'div',
              {
                ...
                className: [
                  ...
                  m ? '__dumi-default-previewer-target' : '',
                ]
                  .filter(Boolean)
                  .join(' '),
                id: p.identifier,
              ...
              p.iframe &&
                a.createElement('div', { className: '__dumi-default-previewer-browser-nav' }),
              a.createElement(
                'div',
                {
                  ref: u,
                      ...
                      i.ErrorBoundary,
                      {
                        fallbackRender: function (e) {
                          ...
                          return a.createElement(
                            L.Z,
                            { type: 'error' },
                            a.createElement('h4', null, t.message || 'This demo has been crashed.'),
                            t.stack &&
                              a.createElement(
                                'details',
                                null,
                                a.createElement('summary', null, 'Error stack'),
                                a.createElement('pre', null, t.stack),
                              ),
                          );
                        },
                      },
              ...
              a.createElement(
                ...
                p.title && a.createElement(s.AnchorLink, { to: '#'.concat(p.identifier) }, p.title),
                p.description &&
                  a.createElement('div', { dangerouslySetInnerHTML: { __html: p.description } }),
              ),
              a.createElement(
                'div',
              ...
              j &&
                a.createElement(
                    ...
                    a.createElement(
                      ...
                      Object.keys(p.sources).map(function (e) {
                        return a.createElement(r.J, {
                          tab: '_' === e ? 'index.'.concat(M(e, p.sources[e])) : e,
                          key: e,
                        });
                      }),
                    ),
                  a.createElement(
                    ...
                    a.createElement(F, { code: W, lang: B, showCopy: !1 }),
                  ),
                ),
            )
          );
    ...
    52444: function (e, t, n) {
      (function (e, a) {
          ...
          l = (function (e) {
              ...
              return (
                ...
                (t.resetErrorBoundary = function () {
                  for (var e, n = arguments.length, a = new Array(n), r = 0; r < n; r++)
                    a[r] = arguments[r];
                  null == t.props.onReset || (e = t.props).onReset.apply(e, a), t.reset();
                }),
                t
              );
            }
            ...
            return (
              ...
              (n.componentDidCatch = function (e, t) {
                var n, a;
                null == (n = (a = this.props).onError) || n.call(a, e, t);
              }),
              (n.componentDidUpdate = function (e, t) {
                ...
                null !== r &&
                  null !== t.error &&
                  o(e.resetKeys, i) &&
                  (null == (n = (a = this.props).onResetKeysChange) || n.call(a, e.resetKeys, i),
                  this.reset());
              }),
              (n.render = function () {
                ...
                if (null !== e) {
                  ...
                  if (a.isValidElement(i)) return i;
                  if ('function' === typeof n) return n(o);
                  if (r) return a.createElement(r, o);
                  throw new Error(
        ...
        function u(e, t) {
          var n = function (n) {
              return a.createElement(l, t, a.createElement(e, n));
            },
