  ...
  var e = {
      ...
      48059: function (e, t, n) {
        ...
        function A(e) {
          var t = e.route,
            n = e.opts,
            r = e.props,
            o = j(f(f({}, n), {}, { routes: t.routes || [], rootRoutes: n.rootRoutes }), {
              location: r.location,
            }),
            a = t.component,
            u = t.wrappers;
        ...
        function L(e) {
          ...
          return (
            i.useEffect(
              function () {
                function r(t, r) {
                  var i = u.matchRoutes(e.routes, t.pathname);
                  'undefined' !== typeof document &&
                    void 0 !== n.defaultTitle &&
                    (document.title =
                      (i.length && i[i.length - 1].route.title) || n.defaultTitle || ''),
                    e.plugin.applyPlugins({
                      key: 'onRouteChange',
                      type: o.ApplyPluginsType.event,
                      args: { routes: e.routes, matchedRoutes: i, location: t, action: r },
                    });
                }
                return (
            ...
            c['default'].createElement(o.Router, { history: t }, j(n))
          );
        }
        function M(e) {
        ...
        var x = b(function (e, t) {
            ...
            return u.createElement(i.s6.Consumer, null, function (e) {
              ...
              var n = x || e.location,
                ...
                A = !!(y ? y(C, n) : C),
                R = A ? w(h, a) : h,
                j = A ? (0, l.default)({}, k, {}, d) : k,
                I = (0, l.default)(
                  { 'aria-current': (A && r) || null, className: R, style: j, to: o },
                  P,
                );
              return g !== b ? (I.ref = t || _) : (I.innerRef = _), u.createElement(m, I);
            });
          }),
          E = n(85440);
        function S(e, t) {
      ...
      83233: function (e, t, n) {
        ...
        function j(e) {
          ...
          var x = E();
          function P(e) {
            (0, r.default)(Z, e), (Z.length = t.length), x.notifyListeners(Z.location, Z.action);
          }
          function j(e) {
            O(e) || M(v(e.state));
          }
                ...
                if (n)
                  if ((t.pushState({ key: a, state: l }, null, r), u)) window.location.href = r;
                    ...
                    var c = U.indexOf(Z.location.key),
                      s = U.slice(0, c + 1);
                    s.push(i.key), (U = s), P({ action: o, location: i });
                  }
              ...
              if (e) {
                ...
                if (n)
                  if ((t.replaceState({ key: a, state: l }, null, r), u))
                    ...
                    var c = U.indexOf(Z.location.key);
                    -1 !== c && (U[c] = i.key), P({ action: o, location: i });
                  }
          ...
          function q(e) {
            (H += e),
              1 === H && 1 === e
                ...
                : 0 === H &&
                  (window.removeEventListener(C, j), o && window.removeEventListener(A, I));
          }
          var K = !1;
          function Q(e) {
            void 0 === e && (e = !1);
        ...
        function D(e) {
          ...
          var v = E();
          function g(e) {
            (0, r.default)(X, e), (X.length = t.length), v.notifyListeners(X.location, X.action);
          }
          var x = !1,
            T = null;
          function _(e, t) {
          ...
          function Q(e) {
            (K += e),
              1 === K && 1 === e
                ...
                : 0 === K && window.removeEventListener(I, O);
          }
          var G = !1;
          function Z(e) {
            void 0 === e && (e = !1);
              ...
              ? i.createElement(
                  ...
                  e.map(function (e, n) {
                    return i.createElement(r.AW, {
                      ...
                      render: function (n) {
                        return e.render
                          ? e.render((0, o.default)({}, n, {}, t, { route: e }))
                          : i.createElement(e.component, (0, o.default)({}, n, t, { route: e }));
                      },
                    });
                  }),
                )
          ...
          (t.unstable_scheduleCallback = function (e, i, a) {
            ...
            return (
              ...
              l > u
                ...
                : ((e.sortIndex = a), k(O, e), L || I || ((L = !0), n(U))),
              e
            );
          }),
      ...
      60535: function (e, t, n) {
        ...
        (j.Map = I),
          ...
          'undefined' !== typeof window && (window.__NEXT_PRELOADREADY = j.preloadReady);
        var F;
        function U(e) {
          var t = e.fns,
            n = e.args;
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  switch (
                                    ...
                                    while (1)
                                      switch ((e.prev = e.next)) {
                                        case 0:
                                          if (
                                            (N(
                                              'function' === typeof o || 'object' === l(o) || D(o),
                                              'applyPlugins failed, all hooks for key '.concat(
                                                t,
                                                ' must be function, plain object or Promise.',
                                              ),
                    ...
                    case F.compose:
                      return function () {
                        return U({ fns: c.concat(o), args: i })();
                      };
                  }
                },
              },
      ...
      4350: function (e, t, n) {
            ...
            var r = e.history,
              ...
              c = (0, i.ob)(
                t
                  ? 'string' === typeof n
                    ? N(n, t.params)
                    : (0, g.default)({}, n, { pathname: N(n.pathname, t.params) })
                  : n,
              );
            return u
              ? (l(c), null)
              : o.createElement(A, {
                  ...
                  onUpdate: function (e, t) {
                    var n = (0, i.ob)(t.to);
                    (0, i.Hp)(n, (0, g.default)({}, c, { key: n.key })) || l(c);
                  },
                  to: n,
                });
          });
              ...
              return o.createElement(P.Consumer, null, function (t) {
                ...
                var n = e.props.location || t.location,
                  r = e.props.computedMatch
                    ...
                    : t.match,
                  i = (0, g.default)({}, t, { location: n, match: r }),
                  a = e.props,
                  u = a.children,
                  l = a.component,
                  c = a.render;
        ...
        function H(e, t) {
          return e ? (0, g.default)({}, t, { pathname: W(e) + t.pathname }) : t;
        }
        function q(e, t) {
          if (!e) return t;
          var n = W(e);
          return 0 !== t.pathname.indexOf(n)
            ? t
            : (0, g.default)({}, t, { pathname: t.pathname.substr(n.length) });
        }
        function K(e) {
        ...
        var Z = (function (e) {
          ...
          return (
            ...
            (n.render = function () {
              ...
              return o.createElement(O, (0, g.default)({}, c, { history: s, staticContext: a }));
            }),
            t
          );
        })(o.Component);
                ...
                return (
                  o.Children.forEach(e.props.children, function (e) {
                    if (null == r && o.isValidElement(e)) {
                      ...
                      r = a ? V(i.pathname, (0, g.default)({}, e.props, { path: a })) : t.match;
                    }
                  }),
        ...
        function X(e) {
          var t = 'withRouter(' + (e.displayName || e.name) + ')',
            n = function (t) {
              ...
              return o.createElement(P.Consumer, null, function (t) {
                return t || (0, m.Z)(!1), o.createElement(e, (0, g.default)({}, r, t, { ref: n }));
              });
            };
        ...
        if (i) {
          ...
          (C = function (e) {
            ...
            (A = function (e, t, n) {
              ...
              if (((n = void 0 === n ? r - i : f(n)), i + n > r)) throw I(_);
            ...
            u(A[T], {
              ...
              getInt32: function (e) {
                return D($(this, 4, e, arguments.length > 1 ? arguments[1] : void 0));
              },
              getUint32: function (e) {
                return D($(this, 4, e, arguments.length > 1 ? arguments[1] : void 0)) >>> 0;
              },
      ...
      82526: function (e, t, n) {
        ...
        var r = n(82109),
          ...
          le = function (e, t, n) {
            ...
            return (
              ...
              f(X, r)
                ? (n.enumerable
                    ? (f(e, D) && e[D][r] && (e[D][r] = !1), (n = b(n, { enumerable: g(0, !1) })))
                    : (f(e, D) || G(e, D, g(1, {})), (e[D][r] = !0)),
                  ie(e, r, n))
                : G(e, r, n)
            );
          },
        ...
        q[B][V] || P(q[B], V, q[B].valueOf), N(q, z), (R[D] = !0);
      },
        ...
        var r = n(82109),
          ...
          $ = function () {
            ...
            if (
              ...
              else D(d, 'string' === typeof c ? ('?' === c.charAt(0) ? c.slice(1) : c) : c + '');
          },
          W = $.prototype;
        u(
          W,
        ...
        if (
          (i &&
            l(Ce, {
              ...
              origin: Ve(Re),
              protocol: Ve(je, function (e) {
                var t = S(this);
                Pe(t, String(e) + ':', ae);
              }),
              username: Ve(Ie, function (e) {
                var t = S(this),
                  n = d(String(e));
                if (!ee(t)) {
                  t.username = '';
              ...
              pathname: Ve(Ue, function (e) {
                var t = S(this);
                t.cannotBeABaseURL || ((t.path = []), Pe(t, e + '', Ee));
              }),
              search: Ve(De, function (e) {
                var t = S(this);
                (e = String(e)),
                  '' == e
                    ? (t.query = null)
      ...
      72408: function (e, t) {
        ...
        function h(e) {
          return null === e || 'object' !== typeof e
            ? null
            : ((e = (d && e[d]) || e['@@iterator']), 'function' === typeof e ? e : null);
        }
        var v = {
            isMounted: function () {
              return !1;
        ...
        (x.constructor = w), y(x, g.prototype), (x.isPureReactComponent = !0);
        var E = Array.isArray,
        ...
        function _(e, t, r) {
          ...
          return { $$typeof: n, type: e, key: a, ref: u, props: i, _owner: k.current };
        }
        function P(e, t) {
          return {
            $$typeof: n,
        ...
        function j(e, t, o, i, a) {
          ...
          else if (((s = h(e)), 'function' === typeof s))
            for (e = s.call(e), c = 0; !(u = e.next()).done; )
              (u = u.value), (s = i + R(u, c++)), (l += j(u, t, o, s, a));
          else if ('object' === u)
            throw (
              ((t = String(e)),
              Error(
        ...
        var M = { current: null },
          N = { transition: null },
          F = { ReactCurrentDispatcher: M, ReactCurrentBatchConfig: N, ReactCurrentOwner: k };
        (t.Children = {
          map: I,
      ...
      16187: function (e, t, n) {
        ...
        function L() {
          if (A) {
            var e = A,
              t = R;
            if (((R = A = null), j(e), t)) for (e = 0; e < t.length; e++) j(t[e]);
          }
        }
        function M(e, t) {
          return e(t);
        ...
        function Dt(e, t, n, r, o) {
          switch (t) {
            ...
            case 'pointerover':
              var i = o.pointerId;
              return At.set(i, Ut(At.get(i) || null, e, t, n, r, o)), !0;
            case 'gotpointercapture':
              return (i = o.pointerId), Rt.set(i, Ut(Rt.get(i) || null, e, t, n, r, o)), !0;
          }
          return !1;
        }
        function zt(e) {
        ...
        function un(e, t, n, r) {
          if (tn)
            if (0 < _t.length && -1 < It.indexOf(e)) (e = Nt(null, e, t, n, r)), _t.push(e);
            else {
              var o = ln(e, t, n, r);
              if (null === o) Ft(e, r);
              else if (-1 < It.indexOf(e)) (e = Nt(o, e, t, n, r)), _t.push(e);
        ...
        function Pr(e, t, n) {
          return (e = or.getPooled(_r.change, e, t, n)), (e.type = 'change'), I(n), Yn(e), e;
        }
        var Or = null,
          Cr = null;
        function Ar(e) {
        ...
        O && (Ir = yt('input') && (!document.documentMode || 9 < document.documentMode));
        var zr = {
            eventTypes: _r,
        ...
        function Ni(e, t, n) {
          ...
          return (
            'object' === typeof i && null !== i
              ? (i = Ei(i))
              : ((o = Lo(t) ? jo : Ao.current),
                (r = t.contextTypes),
                (i = (r = null !== r && void 0 !== r) ? Io(e, o) : Co)),
            (t = new t(n, i)),
        ...
        function Ui(e, t, n, r) {
          var o = e.stateNode;
          (o.props = n), (o.state = e.memoizedState), (o.refs = ji), ki(e);
          var i = t.contextType;
          'object' === typeof i && null !== i
            ? (o.context = Ei(i))
            : ((i = Lo(t) ? jo : Ao.current), (o.context = Io(e, i))),
            Ci(e, n, o, r),
        ...
        function Vi(e) {
          ...
          function p(e, t, n) {
            ...
            if ('object' === typeof t && null !== t) {
              ...
              if (Di(t) || be(t)) return (t = uc(t, e.mode, n, null)), (t.return = e), t;
              Bi(e, t);
            }
            return null;
          }
          ...
          function h(e, t, n, r, o) {
            ...
            if ('object' === typeof r && null !== r) {
              ...
              if (Di(r) || be(r)) return (e = e.get(n) || null), f(t, e, r, o, null);
              Bi(t, r);
            }
            return null;
          }
        ...
        function Ha(e) {
          ...
          if (5 !== e.tag || ('head' !== t && 'body' !== t && !jn(t, e.memoizedProps)))
            for (t = Da; t; ) Ba(e, t), (t = Mn(t.nextSibling));
          if ((Wa(e), 13 === e.tag)) {
          ...
          } else Da = Ua ? Mn(e.stateNode.nextSibling) : null;
          return !0;
        }
        function qa() {
          (Da = Ua = null), (za = !1);
          ...
          if ((xi(t, o), null === t.stateNode))
            ...
            (a = t.stateNode),
              ...
              u !== r || l !== p || Ro.current || Si
                ? ('function' === typeof s && (Ii(t, n, s, r), (p = t.memoizedState)),
                ...
                if (((e = Gi(qi.current)), Ha(t))) {
                  ...
                  switch (((r[Un] = t), (r[Dn] = u), i)) {
                    ...
                    case 'select':
                      ...
                      break;
                    case 'textarea':
                      Ue(r, u), nn('invalid', r), mn(n, 'onChange');
                  }
                  ...
                  switch (
                    ...
                    case 'select':
                      ...
                      break;
                    case 'textarea':
                      Ue(e, r), (c = Fe(e, r)), nn('invalid', e), mn(n, 'onChange');
                      break;
                    default:
                      c = r;
                  }
          ...
          if (0 !== n) {
            ...
            if ((ql(), (e === Ju && n === tl) || Il(e, n), null !== el)) {
              ...
              if ((gi(), (Xu = r), (zu.current = o), nl === Ku))
                throw ((t = rl), Il(e, n), pc(e, n), Pl(e), t);
              if (null === el)
                switch (
                  ...
                  case Gu:
                    if (
                      ...
                      e.timeoutHandle = In($l.bind(null, e), o);
                      break;
                    }
                    $l(e);
                    break;
                  case Zu:
                    ...
                    if (
                      ...
                      e.timeoutHandle = In($l.bind(null, e), r);
                      break;
                    }
                    $l(e);
                    break;
                  case Yu:
                    if (1073741823 !== ol && null !== al) {
                      ...
                      if (
                        ...
                        pc(e, n), (e.timeoutHandle = In($l.bind(null, e), r));
                        break;
                      }
                    }
                    $l(e);
        ...
        function Cl(e) {
          ...
          if ((ql(), (e === Ju && t === tl) || Il(e, t), null !== el)) {
            ...
            if ((gi(), (Xu = n), (zu.current = r), nl === Ku))
              throw ((n = rl), Il(e, t), pc(e, t), Pl(e), n);
                ...
                for (u = e, l = t; null !== fl; ) {
                  ...
                  switch (1038 & w) {
                    case 2:
                      ...
                      break;
                    case 6:
                      Cu(fl), (fl.effectTag &= -3), Iu(fl.alternate, fl);
                      break;
                    case 1024:
                      fl.effectTag &= -1025;
                      break;
              ...
              if (
                ...
                if (
                  ((o = t.stateNode.hydrate) &&
                    ((Da = Mn(t.stateNode.containerInfo.firstChild)), (Ua = t), (o = za = !0)),
                  o)
                )
  ...
  (n.m = e),
    ...
    (function () {
      ...
      n.f.miniCss = function (e, t) {
        var n = { 74: 1, 336: 1, 701: 1, 712: 1, 759: 1, 771: 1 };
        o[e]
          ? t.push(o[e])
          : 0 !== o[e] &&
            n[e] &&
      ...
      var t = [
        {
          ...
          wrappers: [
            (0, r.D8)({
              loader: () => Promise.all([n.e(302), n.e(701), n.e(275)]).then(n.bind(n, 69775)),
            }),
          ],
          component: ((e) =>
            (0, r.D8)({
                        ...
                        switch ((e.prev = e.next)) {
                          ...
                          case 2:
                            return (
                              (t = e.sent),
                              (e.next = 5),
                              Promise.all([n.e(60), n.e(302), n.e(886), n.e(991), n.e(336)]).then(
                                n.bind(n, 65971),
                              )
                            );
                          case 5:
        ...
        { path: '/_demos/:uuid', redirect: '/~demos/:uuid' },
        {
          ...
          wrappers: [
            ...
            (0, r.D8)({
              loader: () => Promise.all([n.e(302), n.e(701), n.e(275)]).then(n.bind(n, 48749)),
            }),
          ],
          routes: [
            {
              ...
              component: (0, r.D8)({
                loader: () =>
                  Promise.all([n.e(60), n.e(302), n.e(886), n.e(991), n.e(759)]).then(
                    n.bind(n, 97627),
                  ),
              }),
              exact: !0,
            ...
            },
            {
              ...
              component: (0, r.D8)({
                loader: () =>
                  Promise.all([n.e(60), n.e(302), n.e(886), n.e(991), n.e(74)]).then(
                    n.bind(n, 41945),
                  ),
              }),
              exact: !0,
            ...
            },
            {
              path: '/',
              component: (0, r.D8)({
                loader: () => Promise.all([n.e(302), n.e(935)]).then(n.bind(n, 35956)),
              }),
              exact: !0,
              meta: {
                filePath: 'docs/index.md',
                updatedTime: 1657954261e3,
                slugs: [
