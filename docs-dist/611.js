      ...
      function o(e, t) {
        ...
        for (var i in e)
          if ('default' !== i && Object.prototype.hasOwnProperty.call(e, i)) {
            var c = l ? Object.getOwnPropertyDescriptor(e, i) : null;
        ...
        if (null != n) {
          ...
          try {
            if (((o = (n = n.call(e)).next), 0 === t)) {
              ...
              c = !1;
            } else for (; !(c = (r = o.call(n)).done) && (i.push(r.value), i.length !== t); c = !0);
          } catch (s) {
            (u = !0), (a = s);
          } finally {
            try {
              ...
              return (
                (null ===
                  (t = r[0].find(function (e) {
                    return new RegExp('/'.concat(e.name, '(/|$)')).test(r[1]);
                  })) || void 0 === t
                  ? void 0
                  : t.name) || e[0].name
              );
        ...
        k = function (e, t, n) {
          var a = function () {
              for (var e, t = arguments.length, n = new Array(t), r = 0; r < t; r++)
                n[r] = arguments[r];
              for (var a = n[0].navs[n[1]] || [], o = '*', l = a.length - 1; l >= 0; l -= 1) {
                var i = a[l],
                  c = [i].concat(i.children).filter(Boolean),
                  u = c.find(function (e) {
                    return (
                      e.path &&
                      new RegExp('^'.concat(e.path.replace(/\.html$/, ''), '(/|.|$)')).test(n[2])
                    );
                  });
                if (u) {
                  o = u.path;
        ...
        S = function e(t) {
          ...
          try {
            for (a.s(); !(r = a.n()).done; ) {
              ...
              if (o.routes && (n = e(o.routes))) break;
            }
          } catch (l) {
            a.e(l);
          } finally {
        ...
        j = function (e) {
          ...
          return r['default'].createElement(
            a['default'].Provider,
            {
              value: {
                config: l,
                meta: f.__pathname === t.pathname ? f : {},
                locale: m,
                nav: l.navs[m] || [],
                menu: d,
                base: p,
      ...
      var r = n(67294),
        ...
        l =
          ...
          function (e) {
            ...
            function s(e) {
              var n = l.replace('/'.concat(i), ''),
                r =
                  t.pathname.replace(new RegExp('^'.concat(l, '(/|$)')), ''.concat(n, '$1')) || '/';
              if (e !== c[0].name) {
                var a = ''.concat(n, '/').concat(e).replace(/\/\//, '/'),
                  o = t.pathname.replace(l.replace(/^\/$/, '//'), '');
                  ...
                  c.length > 2
                    ? r.createElement(
                        'select',
                        {
                          value: i,
                          onChange: function (e) {
                            return o.m.push(s(e.target.value));
                          },
                        },
                        c.map(function (e) {
                          return r.createElement('option', { value: e.name, key: e.name }, e.label);
                        }),
                      )
                    : r.createElement(a.Link, { to: s(u.name) }, u.label),
                )
              : null;
          }),
        i = l,
        c =
          ...
          function (e) {
            ...
            return r.createElement(
              ...
              r.createElement('button', { className: '__dumi-default-navbar-toggle', onClick: t }),
              r.createElement(
                a.Link,
                {
                      ...
                      r.createElement(
                        ...
                        e.children.map(function (e) {
                          return r.createElement(
                            'li',
                            { key: e.path },
                            r.createElement(a.NavLink, { to: e.path }, e.title),
                          );
                        }),
                      );
                  return r.createElement(
                    ...
                    { key: e.title || e.path },
                    e.path
                      ? r.createElement(a.NavLink, { to: e.path, key: e.path }, e.title)
                      : e.title,
                    n,
                  );
                }),
              ...
              .map(function (e) {
                return r.createElement(
                  ...
                  r.createElement(
                    a.AnchorLink,
                    { to: '#'.concat(e.heading) },
                    r.createElement('span', null, e.value),
                  ),
                );
              }),
          );
        ...
        v =
          ...
          function (e) {
            var t = e.mobileMenuCollapsed,
              ...
              g = l.meta,
              b =
                Boolean((g.hero || g.features || g.gapless) && 'site' === m) ||
                !1 === g.sidemenu ||
                void 0;
            return r.createElement(
              'div',
                    ...
                    r.createElement(
                      ...
                      v.map(function (e) {
                        ...
                        return r.createElement(
                          'li',
                          { key: e.path || e.title },
                          e.path ? r.createElement(a.NavLink, { to: e.path }, e.title) : e.title,
                          n,
                        );
                      }),
                    ),
                  r.createElement(i, { location: n }),
                  o,
                ),
                r.createElement(
                  'ul',
                  ...
                  !b &&
                    p.map(function (e) {
                      var t,
                        o = Boolean(null === (t = g.slugs) || void 0 === t ? void 0 : t.length),
                        ...
                        c = l
                          ...
                          : [
                              e.path,
                              n.pathname.startsWith(''.concat(e.path, '/')) && g.title === e.title
                                ? n.pathname
                                : null,
                            ];
                      return r.createElement(
                              ...
                              return r.createElement(
                                ...
                                Boolean(
                                  'menu' === g.toc &&
                                    ...
                                    e.path === n.pathname &&
                                    o,
                                ) && r.createElement(h, { slugs: g.slugs }),
                              );
                            }),
                          ),
                        i && r.createElement(h, { slugs: g.slugs }),
                      );
                    }),
                ),
              ),
          ...
          return (
            (0, r.useEffect)(
              function () {
                Array.isArray(f)
                  ? u(f)
                  : 'function' === typeof f && f('.'.concat(s.current.className));
              },
              [f],
            ),
            r.createElement(
              ...
              r.createElement(
                'input',
                g(
                  { className: '__dumi-default-search-input', type: 'search', ref: s },
                  Array.isArray(f)
                    ? {
                        value: n,
                        onChange: function (e) {
                    ...
                    return r.createElement(
                      ...
                      r.createElement(
                        ...
                        (null === (t = e.parent) || void 0 === t ? void 0 : t.title) &&
                          r.createElement('span', null, e.parent.title),
                        S(n, e.title),
                      ),
                    );
                  }),
                0 === c.length && n && r.createElement('li', { style: { textAlign: 'center' } }, m),
              ),
            )
          );
        };
            ...
            r.createElement(
              'div',
              {
                className: '__dumi-default-dark-switch '.concat(
                  !o && t ? '__dumi-default-dark-switch-open' : '',
                ),
              },
              o
                ? l.map(function (e) {
      ...
      var W = function (e) {
          return r.createElement(
            ...
            r.createElement(
              ...
              e.image && r.createElement('img', { src: e.image }),
              r.createElement('h1', null, e.title),
              r.createElement('div', { dangerouslySetInnerHTML: { __html: e.desc } }),
              e.actions &&
                e.actions.map(function (e) {
                  return r.createElement(
                    a.Link,
                    { to: e.link, key: e.text },
                    r.createElement('button', { type: 'button' }, e.text),
                  );
                }),
            ),
          );
          ...
          return r.createElement(
            ...
            e.map(function (e) {
              return r.createElement(
                ...
                e.link
                  ? r.createElement(a.Link, { to: e.link }, r.createElement('dt', null, e.title))
                  : r.createElement('dt', null, e.title),
                r.createElement('dd', { dangerouslySetInnerHTML: { __html: e.desc } }),
              );
            }),
          );
        },
        U = function (e) {
          var t,
            ...
            M = A && m.hero,
            P = A && m.features,
            N = !1 !== m.sidemenu && !M && !P && !m.gapless,
            L =
              !M &&
              !P &&
              Boolean(null === (t = m.slugs) || void 0 === t ? void 0 : t.length) &&
              ('content' === m.toc || void 0 === m.toc) &&
              !m.gapless,
            C = /^zh|cn$/i.test(d),
            $ = new Date(m.updatedTime),
            D = ''
              .concat($.toLocaleDateString([], { hour12: !1 }), ' ')
              .concat($.toLocaleTimeString([], { hour12: !1 })),
            B =
              { github: 'GitHub', gitlab: 'GitLab' }[
                (null === (n = (p || '').match(/(github|gitlab)/)) || void 0 === n
                  ? void 0
                  : n[1]) || 'nothing'
              ] || g;
          return r.createElement(
            ...
            r.createElement(u, {
              location: l,
              navPrefix: r.createElement(j, null),
              darkPrefix: r.createElement(z, {
                darkSwitch: S,
            ...
            r.createElement(y, {
              darkPrefix: r.createElement(z, { darkSwitch: S, isSideMenu: !0 }),
              mobileMenuCollapsed: w,
              location: l,
            }),
            L && r.createElement(h, { slugs: m.slugs, className: '__dumi-default-layout-toc' }),
            M && W(m.hero),
            P && R(m.features),
            r.createElement(
              'div',
              ...
              !M &&
                ...
                r.createElement(
                  ...
                  B &&
                    r.createElement(
                      a.Link,
                      { to: ''.concat(p, '/edit/').concat(v, '/').concat(m.filePath) },
                      C
                        ? '\u5728 '.concat(B, ' \u4e0a\u7f16\u8f91\u6b64\u9875')
              ...
              (M || P) &&
                ...
                r.createElement('div', {
                  ...
                  dangerouslySetInnerHTML: { __html: m.footer },
                }),
            ),
          );
        },
