        ...
        w = function (e, t, n) {
          var r = function () {
              for (var e, t = arguments.length, n = new Array(t), r = 0; r < t; r++)
                n[r] = arguments[r];
              for (var a = n[0].navs[n[1]] || [], l = '*', o = a.length - 1; o >= 0; o -= 1) {
                var c = a[o],
                  i = [c].concat(c.children).filter(Boolean),
                  u = i.find(function (e) {
                    return (
                      e.path &&
              ...
              return (null === (e = n[0].menus[n[1]]) || void 0 === e ? void 0 : e[l]) || [];
            },
            l = (0, a.useState)(r(e, t, n)),
            o = s(l, 2),
            c = o[0],
            i = o[1];
          return (
        ...
        _ = function e(t) {
          ...
          try {
            for (a.s(); !(r = a.n()).done; ) {
              ...
              if (l.routes && (n = e(l.routes))) break;
            }
          } catch (o) {
            a.e(o);
          } finally {
        ...
        S = function (e) {
          ...
          return a['default'].createElement(
            l['default'].Provider,
            {
              value: {
                config: o,
                meta: m.__pathname === t.pathname ? m : {},
                locale: f,
                nav: o.navs[f] || [],
                menu: d,
                base: p,
      ...
      var r = n(67294),
        ...
        o =
          ...
          function (e) {
            ...
            function s(e) {
              var n = o.replace('/'.concat(c), ''),
                r =
                  t.pathname.replace(new RegExp('^'.concat(o, '(/|$)')), ''.concat(n, '$1')) || '/';
              if (e !== i[0].name) {
                var a = ''.concat(n, '/').concat(e).replace(/\/\//, '/'),
                  l = t.pathname.replace(o.replace(/^\/$/, '//'), '');
                return ''.concat(a).concat(l).replace(/\/$/, '');
              }
              return r;
            }
            return u
              ? r.createElement(
                  'div',
                  { className: '__dumi-default-locale-select', 'data-locale-count': i.length },
                  i.length > 2
                    ? r.createElement(
                        'select',
                        {
                          value: c,
                          onChange: function (e) {
                            return l.m.push(s(e.target.value));
                          },
                        },
                        i.map(function (e) {
        ...
        v =
          ...
          function (e) {
            var t = e.mobileMenuCollapsed,
              ...
              g = o.meta,
              b =
                Boolean((g.hero || g.features || g.gapless) && 'site' === f) ||
                !1 === g.sidemenu ||
                void 0;
            return r.createElement(
              'div',
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  !b &&
                    p.map(function (e) {
                      var t,
                        l = Boolean(null === (t = g.slugs) || void 0 === t ? void 0 : t.length),
                      ...
                      return r.createElement(
                        ...
                        c && r.createElement(h, { slugs: g.slugs }),
                      );
                    }),
                ),
              ),
          ...
          return (
            (0, r.useEffect)(
              function () {
                Array.isArray(m)
                  ? u(m)
                  : 'function' === typeof m && m('.'.concat(s.current.className));
              },
              [m],
            ),
            r.createElement(
              ...
              r.createElement(
                ...
                0 === i.length && n && r.createElement('li', { style: { textAlign: 'center' } }, f),
              ),
            )
          );
        };
                  ...
                  return r.createElement(
                    'button',
                    {
                      ...
                      className: '__dumi-default-dark-moon '.concat(
                        e === m ? '__dumi-default-dark-switch-active' : '',
                      ),
                    },
                    d,
                  );
            ...
            r.createElement(
              'div',
              {
                className: '__dumi-default-dark-switch '.concat(
                  !l && t ? '__dumi-default-dark-switch-open' : '',
                ),
              },
              l
                ? o.map(function (e) {
      ...
      var R = function (e) {
        ...
        W = function (e) {
          ...
          return r.createElement(
            ...
            r.createElement(u, {
              location: o,
              navPrefix: r.createElement(A, null),
            ...
            r.createElement(y, {
              darkPrefix: r.createElement(z, { darkSwitch: O, isSideMenu: !0 }),
              mobileMenuCollapsed: w,
              location: o,
            }),
            C && r.createElement(h, { slugs: f.slugs, className: '__dumi-default-layout-toc' }),
            N && R(f.hero),
            L && U(f.features),
            r.createElement(
              'div',
              ...
              !N &&
                ...
                r.createElement(
                  ...
                  D &&
                    r.createElement(
                      a.Link,
                      { to: ''.concat(p, '/edit/').concat(v, '/').concat(f.filePath) },
                      P
                        ? '\u5728 '.concat(D, ' \u4e0a\u7f16\u8f91\u6b64\u9875')
